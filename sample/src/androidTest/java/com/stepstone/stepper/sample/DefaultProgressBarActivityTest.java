...
/**
 * Performs tests on a progress bar stepper i.e. the one with {@code ms_stepperType="progress_bar"}.
 *
 * @author Piotr Zawadzki
 */
@LargeTest
public class DefaultProgressBarActivityTest extends AbstractActivityTest<DefaultProgressBarActivity> {
